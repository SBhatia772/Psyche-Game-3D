...
public class VattalusSceneController1 : MonoBehaviour
{
    ...
    public VattalusFirstPersonCamera1 firstPersonController;
    ...
    public VattalusSpaceshipController1 spaceshipController;
